...
Components are promoted from Beta to Stable once they pass a full accessibility audit, have complete test coverage, and their API has been validated through production usage. Check the [Changelog](./changelog.md) for details on each release.
