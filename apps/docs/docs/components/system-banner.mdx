...
title: "System banner"
description: "A persistent, full-width banner anchored to the top of the viewport for system-level announcements."
eyebrow: "MESSAGING"
status: "Draft"
hide_title: true
---
...
import { SystemBanner } from '../../../../packages/components/src/SystemBanner';
...
<div style={{background: '#F3F3F3', borderRadius: '12px', padding: '32px', margin: '24px 0', display: 'flex', justifyContent: 'center'}}>
  <div style={{maxWidth: '600px', width: '100%', display: 'flex', flexDirection: 'column', gap: '12px'}}>
    <SystemBanner variant="info">A new version of the platform is available.</SystemBanner>
    <SystemBanner variant="warning">Scheduled maintenance tonight from 10 pm to 2 am UTC.</SystemBanner>
    <SystemBanner variant="error">Critical outage in progress. Our team is investigating.</SystemBanner>
  </div>
</div>
