...
A calendar-based input that allows users to select a single date, a date range, or navigate between months and years. Combines a text input trigger with a dropdown calendar popover.

**Status:** Planned

**Common alternative names:** Calendar picker, date selector, datepicker
