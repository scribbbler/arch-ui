...
A phone number input with a country code selector button. The country button displays the dial code for the selected country, and the input field accepts digits only.

**Status:** Stable

**Common alternative names:** Telephone input, phone field, international phone number
