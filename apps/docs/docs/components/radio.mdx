...
sidebar_label: Radio
title: "Radio"
description: "A single option within a mutually exclusive group, rendered as a native radio input with a custom visual."
...
<div style={{background: '#F3F3F3', borderRadius: '12px', padding: '32px', margin: '24px 0', display: 'flex', justifyContent: 'center'}}>
  <RadioGroup legend="Size" name="size-preview" value="md" onChange={() => {}}>
