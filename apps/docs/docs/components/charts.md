...
A set of data visualisation components for presenting quantitative information as graphical displays. Charts translate numbers into visual patterns -- bars, lines, areas, and segments -- making trends, comparisons, and distributions easier to interpret than raw tables.
