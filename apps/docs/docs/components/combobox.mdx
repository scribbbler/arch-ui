...
title: "Combobox"
description: "A searchable dropdown select supporting single and multi-select, creatable options, and keyboard navigation."
...
import { Combobox } from '../../../../packages/components/src/Combobox';
