...
description: "A fixed navigation bar anchored to the bottom of the viewport for mobile and small-screen layouts."
eyebrow: "NAVIGATION"
status: "Draft"
hide_title: true
---
...
import { BottomNavigation } from '../../../../packages/components/src/BottomNavigation';
  ...
  <div style={{maxWidth: '400px', width: '100%'}}>
    <BottomNavigation
      items={[
        ...
        { key: 'search', label: 'Search', icon: <span aria-hidden="true">&#8981;</span> },
