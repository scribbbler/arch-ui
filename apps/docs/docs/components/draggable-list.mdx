...
description: "A list whose items can be reordered via drag-and-drop for prioritisation or manual arrangement."
...
import { DndList } from '../../../../packages/components/src/DndList';
