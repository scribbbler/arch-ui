...
sidebar_label: Color
title: Color
description: A two-tier system of primitive palettes and semantic tokens that keeps every surface, text, and border themeable without touching component code.
eyebrow: Styles
status: Draft
hide_title: true
---
...
<Guidance.Grid>
  <Guidance.Do description="Reference semantic tokens so components adapt to theme changes automatically.">
    <p style={{margin: 0}}><code>color: var(--color-text-default);</code></p>
    <p style={{margin: 0}}><code>background: var(--color-background-subtle);</code></p>
  </Guidance.Do>
  <Guidance.Dont description="Hardcoded hex values or primitive tokens break theming.">
    <p style={{margin: 0}}><code>color: #282828;</code></p>
    <p style={{margin: 0}}><code>background: var(--color-gray-50);</code></p>
  </Guidance.Dont>
</Guidance.Grid>
...
<Guidance.Grid>
  <Guidance.Do description="Combine color with icons and descriptive text for validation errors.">
    <p style={{margin: 0}}>Red border <em>and</em> an error icon <em>and</em> descriptive text.</p>
  </Guidance.Do>
  <Guidance.Dont description="Don't rely on color alone to signal state.">
    <p style={{margin: 0}}>A red border as the only indicator that a field is invalid.</p>
  </Guidance.Dont>
</Guidance.Grid>
