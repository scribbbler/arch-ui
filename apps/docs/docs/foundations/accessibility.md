...
Arch UI is built to meet WCAG 2.1 AA conformance out of the box. Every component ships with semantic HTML, keyboard support, and screen reader compatibility so that teams can focus on building features rather than retrofitting access.
